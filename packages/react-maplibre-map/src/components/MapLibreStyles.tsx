...
`;
const MAPLIBRE_GL_STYLES_ID = "maplibregl-gl-styles";
export const MapLibreStyles = () => {
  const style = document.getElementById(MAPLIBRE_GL_STYLES_ID);
  if (style) {
    return;
  }

  return <style id={MAPLIBRE_GL_STYLES_ID}>{MAPLIBRE_GL_STYLES}</style>;
};
