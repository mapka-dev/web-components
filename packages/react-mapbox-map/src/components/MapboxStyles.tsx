...
`;
const MAPBOX_GL_STYLES_ID = "mapboxgl-gl-styles";
export const MapboxStyles = () => {
  const style = document.getElementById(MAPBOX_GL_STYLES_ID);
  if (style) {
    return;
  }

  return <style id={MAPBOX_GL_STYLES_ID}>{MAPBOX_GL_STYLES}</style>;
};
